...
var MessagesEnUS = map[string]string{
	...
	"validation.model_mapping_alias_required":               "Model alias cannot be empty",
	"validation.model_mapping_duplicate_alias":              "Model alias already exists: {{.model}}",
	"validation.model_mapping_targets_required":             "Model mapping '{{.model}}' must contain at least one target",
	...
	"dashboard.prompt_tokens":                                    "Input",
	"dashboard.uncached_prompt_tokens":                           "Input",
	"dashboard.cached_tokens":                                    "Cached",
	"dashboard.completion_tokens":                                "Output",
	"dashboard.total_tokens":                                     "Total",
