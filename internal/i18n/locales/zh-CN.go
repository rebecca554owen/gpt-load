...
var MessagesZhCN = map[string]string{
	...
	"validation.model_mapping_alias_required":               "模型别名不能为空",
	"validation.model_mapping_duplicate_alias":              "模型别名已存在: {{.model}}",
	"validation.model_mapping_targets_required":             "模型映射 '{{.model}}' 必须包含至少一个目标配置",
	...
	"dashboard.prompt_tokens":                                    "输入",
	"dashboard.uncached_prompt_tokens":                           "输入",
	"dashboard.cached_tokens":                                    "缓存",
	"dashboard.completion_tokens":                                "输出",
	"dashboard.total_tokens":                                     "总量",
