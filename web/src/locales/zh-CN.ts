export default {
  ...
  dashboard: {
    ...
    errorRate24h: "错误率",
    totalRequests: "总请求数",
    tokenView: "Token 消耗趋势",
    requestView: "请求趋势",
    tokenSpeedView: "Token 速度趋势",
    token_speedView: "Token 速度趋势",
    chartAriaLabel: "{viewType}图表",
    last1Hour: "1小时",
    last5Hours: "5小时",
    last24Hours: "24小时",
    last1Week: "1星期",
  ...
  keys: {
    ...
    copyFailed: "复制失败",
    testingKey: "正在测试密钥...",
    testingKeyWithEllipsis: "正在测试密钥…",
    validatingKeysMsgWithEllipsis: "正在验证{type}密钥…",
  ...
  subGroups: {
    ...
    noSubGroups: "暂无子分组",
    totalSubGroups: "共 {count} 个子分组",
  },
  modelMappings: {
    addModelMapping: "添加模型映射",
    modelAlias: "模型别名",
    modelAliasPlaceholder: "请输入模型别名",
    modelAliasRequired: "请输入模型别名",
    duplicateModelAlias: "模型别名已存在",
    noModelMappings: "暂无模型映射",
    removeModelMapping: "移除模型映射",
    confirmRemoveModelMapping: '确定要移除模型映射 "{model}" 吗？',
    editModelMapping: "编辑模型映射",
    duplicate: "复制",
    duplicateModelMapping: "复制模型映射",
    copySuccess: "已复制模型别名: {alias}",
    copyFailed: "复制失败，请手动复制",
    testSuccess: '模型 "{model}" 测试成功！耗时 {duration}',
    testFailed: '模型 "{model}" 测试失败：{error}',
    ...
    failed: "失败",
    targetConfig: "目标配置",
    targetSubGroup: "目标子分组",
    clickToEditModel: "点击编辑模型",
    addTarget: "添加目标",
    atLeastOneTarget: "至少需要一个有效的目标配置",
    invalidWeight: "权重不能为负数",
    targetsRequired: "需要至少一个有效的目标配置",
    disabled: "已禁用",
    weightZeroDisabled: "权重为 0 时禁用此渠道",
    testingModel: '正在测试模型 "{model}" 的可用性...',
    duplicatedMappingInfo: "已复制模型映射配置，请编辑新的模型别名",
    sortedByModelName: "按模型名字母顺序排序",
    wildcardHint: "支持 * 匹配 0 个或多个字符，? 匹配单个字符",
    wildcardExample1:
    ...
    totalMappings: "共 {count} 个模型映射",
  },
  groups: {
    modelMappingStrict: "模型映射严格模式",
    modelMappingStrictTip: "启用后，未匹配到模型别名时将拒绝请求而不是使用默认池",
    modelMappingStrictEnabled: "严格模式：拒绝未匹配的模型",
    modelMappingStrictDisabled: "宽松模式：未匹配时使用默认池",
    modelMappingStrictWarning:
      "严格模式下，只有在模型映射中配置的模型别名（支持通配符）才能被请求，其他模型将返回错误",
    modelMappingLooseInfo: "宽松模式下，未匹配到模型别名的请求将使用默认池中的所有可用模型",
  },
  logs: {
    title: "日志",
    loadFailed: "加载日志失败",
