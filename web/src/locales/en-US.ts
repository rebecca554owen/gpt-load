export default {
  ...
  dashboard: {
    ...
    errorRate24h: "Error Rate",
    totalRequests: "Total Requests",
    tokenView: "Token Trends",
    requestView: "Request Trends",
    tokenSpeedView: "Token Speed Trends",
    token_speedView: "Token Speed Trends",
    chartAriaLabel: "{viewType} Chart",
    last1Hour: "1 Hour",
    last5Hours: "5 Hours",
  ...
  keys: {
    ...
    testingKeyWithEllipsis: "Testing key…",
    validatingKeysMsgWithEllipsis: "Validating {type} keys…",
    testSuccess: "Key test successful (Duration: {duration})",
    testFailed: "Key test failed: Invalid API key",
    disableKey: "Disable Key",
    confirmDisableKey: 'Are you sure to disable key "{key}"?',
    ...
    modelMappingConfig: "Model Mapping Configuration",
  ...
  subGroups: {
    ...
    noSubGroups: "No sub groups",
    totalSubGroups: "{count} sub groups in total",
  },
  modelMappings: {
    addModelMapping: "Add Model Mapping",
    modelAlias: "Model Alias",
    modelAliasPlaceholder: "Please enter model alias",
    modelAliasRequired: "Please enter model alias",
    duplicateModelAlias: "Model alias already exists",
    noModelMappings: "No model mappings",
    removeModelMapping: "Remove Model Mapping",
    confirmRemoveModelMapping: 'Are you sure to remove model mapping "{model}"?',
    editModelMapping: "Edit Model Mapping",
    duplicate: "Copy",
    duplicateModelMapping: "Copy Model Mapping",
    copySuccess: "Copied model alias: {alias}",
    copyFailed: "Copy failed, please copy manually",
    testSuccess: 'Model "{model}" test successful! Duration: {duration}',
    testFailed: 'Model "{model}" test failed: {error}',
    testFailedGeneric: "Test failed",
    testModelFailed: "Test model failed",
    unknownError: "Unknown error",
    testInProgress: "Testing",
    test: "Test",
    failed: "Failed",
    targetConfig: "Target Configuration",
    targetSubGroup: "Target Sub Group",
    clickToEditModel: "Click to edit model",
    addTarget: "Add Target",
    atLeastOneTarget: "At least one valid target configuration is required",
    invalidWeight: "Weight cannot be negative",
    targetsRequired: "At least one valid target configuration is required",
    disabled: "Disabled",
    weightZeroDisabled: "Weight 0 disables this channel",
    testingModel: 'Testing model "{model}" availability...',
    duplicatedMappingInfo: "Model mapping configuration copied, please edit the new model alias",
    sortedByModelName: "Sorted by model name alphabetically",
    wildcardHint: "Supports * to match 0 or more characters, ? to match a single character",
    wildcardExample1:
      "claude-* → claude-haiku-4-5-20251001, claude-opus-4-6, claude-sonnet-4-5-20250929",
    wildcardExample2: "*-thinking → gemini-2.5-flash-thinking, deepseek-v3.2-thinking",
    totalMappings: "{count} model mappings in total",
  },
  groups: {
    modelMappingStrict: "Model Mapping Strict Mode",
    modelMappingStrictTip:
      "When enabled, requests with unmatched model aliases will be rejected instead of using the default pool",
    modelMappingStrictEnabled: "Strict mode: Reject unmatched models",
    modelMappingStrictDisabled: "Loose mode: Use default pool for unmatched",
    modelMappingStrictWarning:
      "In strict mode, only model aliases configured in mappings (wildcards supported) can be requested, other models will return an error",
    modelMappingLooseInfo:
      "In loose mode, requests with unmatched model aliases will use all available models from the default pool",
  },
  logs: {
    title: "Logs",
