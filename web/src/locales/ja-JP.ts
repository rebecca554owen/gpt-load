export default {
  ...
  modelMappings: {
    ...
    modelAlias: "モデルエイリアス",
    modelAliasPlaceholder: "モデルエイリアスを入力してください",
    modelAliasRequired: "モデルエイリアスを入力してください",
    duplicateModelAlias: "モデルエイリアスは既に存在します",
    totalMappings: "合計 {total} 個のモデルマッピング",
    noModelMappings: "モデルマッピングがありません",
    removeModelMapping: "モデルマッピングを削除",
    confirmRemoveModelMapping: 'モデルマッピング "{model}" を削除してもよろしいですか？',
    editModelMapping: "モデルマッピングを編集",
    duplicate: "コピー",
    duplicateModelMapping: "モデルマッピングをコピー",
    copySuccess: "モデルエイリアスをコピーしました: {alias}",
    copyFailed: "コピーに失敗しました、手動でコピーしてください",
    testSuccess: 'モデル "{model}" テスト成功！所要時間: {duration}',
    testFailed: 'モデル "{model}" テスト失敗：{error}',
    testFailedGeneric: "テスト失敗",
    testModelFailed: "モデルテスト失敗",
    unknownError: "不明なエラー",
    noAvailableKeys: "利用可能なキーがありません",
    subGroupNoAvailableKeys: 'サブグループ "{name}" に利用可能なキーがありません',
    testInProgress: "テスト中",
    test: "テスト",
    failed: "失敗",
    targetConfig: "ターゲット設定",
    targetSubGroup: "ターゲットサブグループ",
    clickToEditModel: "クリックしてモデルを編集",
    addTarget: "ターゲットを追加",
    atLeastOneTarget: "少なくとも1つの有効なターゲット設定が必要です",
    invalidWeight: "ウェイトは負の値にできません",
    targetsRequired: "少なくとも1つの有効なターゲット設定が必要です",
    disabled: "無効",
    weightZeroDisabled: "ウェイト0でこのチャンネルを無効化",
    testingModel: 'モデル "{model}" の可用性をテスト中...',
    duplicatedMappingInfo:
      "モデルマッピング設定をコピーしました。新しいモデルエイリアスを編集してください",
    sortedByModelName: "モデル名のアルファベット順でソート",
    wildcardHint: "* は0文字以上、? は1文字にマッチします",
    wildcardExample1:
  ...
  groups: {
    modelMappingStrict: "モデルマッピング厳格モード",
    modelMappingStrictTip:
      "有効にすると、マッチしないモデルエイリアスのリクエストが拒否され、デフォルトプールが使用されません",
    modelMappingStrictEnabled: "厳格モード: マッチしないモデルを拒否",
    modelMappingStrictDisabled: "緩和モード: マッチしない場合はデフォルトプールを使用",
    modelMappingStrictWarning:
      "厳格モードでは、マッピングで設定されたモデルエイリアス（ワイルドカード対応）のみがリクエスト可能で、他のモデルはエラーを返します",
    modelMappingLooseInfo:
      "緩和モードでは、マッチしないモデルエイリアスのリクエストはデフォルトプールのすべての利用可能なモデルを使用します",
  },
  subGroups: {
    addSubGroup: "サブグループを追加",
    subGroup: "サブグループ",
