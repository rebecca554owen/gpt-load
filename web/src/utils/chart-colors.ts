...
// Token speed color palette - Cyber Speed Heat Gradient
// From hottest (fastest) to coolest (slowest): Orange → Gold → Cyan
const tokenSpeedColors = [
  ...
  "#00D9FF", // Rank 6: Arctic Cyan
  "#00B4D8", // Rank 7: Deep Ocean - cool cruise
];
